...
import aaronjenkins.swingcient.EntityListTableModel;
import aaronjenkins.swingcient.ModelController;
...
public class ControlsJPanel extends javax.swing.JPanel {
    ...
    public ControlsJPanel(ModelController modelController) {
        ...
        jTable1.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent event) {
                ...
                meter.setLocation(field_A);
                meter.setScheduleList(field_B);
                meter.setField_C(field_C);
                try {
                    meter.setId(Integer.parseInt(entityIdstr));
                } catch (NumberFormatException ex) {

                }
                entityFieldsJPanel1.setModelMeter(meter);
    ...
    private void initComponents() {
        ...
        entityFieldsJPanel1 = new aaronjenkins.swingcient.gui.EntityFieldsJPanel();
    ...
    private void clearSearchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clearSearchButtonActionPerformed
        ...
        Meter templateMeter = new Meter();
        entityFieldsJPanel1.setModelMeter(templateMeter);
        ...
        SwingWorker worker = new SwingWorker<String, Void>() {
            ...
            public String doInBackground() {
                ...
                m_modelController.findMatchingSearch(templateMeter);
                return null;
            }
    ...
    private void findMatchingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_findMatchingButtonActionPerformed
        ...
        Meter templateMeter = entityFieldsJPanel1.getModelMeter();
        jTable1.clearSelection();
        // running query in seperate thread 
        SwingWorker worker = new SwingWorker<String, Void>() {
            @Override
    ...
    private aaronjenkins.swingcient.gui.EntityFieldsJPanel entityFieldsJPanel1;
