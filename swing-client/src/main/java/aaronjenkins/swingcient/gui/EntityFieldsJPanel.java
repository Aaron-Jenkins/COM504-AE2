 ...
 */
package aaronjenkins.swingcient.gui;
...
public class EntityFieldsJPanel extends javax.swing.JPanel {
    ...
    private Meter modelMeter = new Meter();

    public Meter getModelMeter() {

        if ("".equals(jTextLocation.getText())) {
            this.modelMeter.setLocation(null);
        } else {
            this.modelMeter.setLocation(jTextLocation.getText());
        }

        if ("".equals(jTextScheduleList.getText())) {
            this.modelMeter.setScheduleList(null);
        } else {
            this.modelMeter.setScheduleList(jTextScheduleList.getText());
        }

        if ("".equals(jTextField_C.getText())) {
            this.modelMeter.setField_C(null);
        } else {
            this.modelMeter.setField_C(jTextField_C.getText());
        }

        String intText = jTextField_id.getText();
        try {
            Integer id = Integer.parseInt(intText);
            this.modelMeter.setId(id);
    ...
    public void setModelMeter(Meter modelMeter) {
        LOG.debug("setting model entity to " + modelMeter);
        this.modelMeter = modelMeter;
        jTextLocation.setText(this.modelMeter.getLocation());
        jTextScheduleList.setText(this.modelMeter.getScheduleList());
        jTextField_C.setText(this.modelMeter.getField_C());

        String idtxt = (modelMeter.getId() == null) ? null : modelMeter.getId().toString();
    ...
    private void initComponents() {
        ...
        jTextScheduleList = new javax.swing.JTextField();
        ...
        jLabelLocation.setText("field_A");

        jTextLocation.addActionListener(new java.awt.event.ActionListener() {
        ...
        jTextScheduleList.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jLabelLocation, javax.swing.GroupLayout.DEFAULT_SIZE, 74, Short.MAX_VALUE)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(jTextScheduleList, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jTextScheduleList, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
...
/*    private void jTextField_CActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_CActionPerformed
    ...
    private void jTextField_idActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField_idActionPerformed
        ...
        try {
            ...
            this.modelMeter.setId(null); // should not happen because checked
        }
    ...
    private javax.swing.JLabel jLabelScheduleList;
    ...
    private javax.swing.JTextField jTextScheduleList;
