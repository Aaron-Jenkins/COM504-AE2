...
import aaronjenkins.swingcient.gui.AppMainJFrame;
...
public class MainApp {
    ...
    public static void main(String[] args) {
        ...
        //setting up dao
        MeterDAO meterDAO = new MeterDAOJaxbImpl(dataFileLocation);
        ...
        ModelController controller = new ModelControllerImpl(meterDAO, entityClientLoader);
