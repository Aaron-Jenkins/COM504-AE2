 ...
 */
package aaronjenkins.web.rest.client;

import aaronjenkins.model.Meter;
import aaronjenkins.model.ReplyMessage;
import aaronjenkins.model.RestInterface;
...
public class RestClientJerseyImpl implements RestInterface {
    ...
    public ReplyMessage retrieveMatchingEntites(Meter meterTempate) {
        ...
        try {
            ...
            response = builder.post(javax.ws.rs.client.Entity.entity(meterTempate, mediaType));
    ...
    public ReplyMessage retrieveEntity(Integer id) {
        ...
        try {
            ...
            throw new RuntimeException("cannot run rest client to retrieveMeter: Exception:", e);
        }
